...
const SPDs: {
	...
	{ label: 'FL3.1', desc: 'CIE 2932 K Standard halophosphate lamp', SPD: std.SPDofFL3_1 },
	{ label: 'FL3.2', desc: 'CIE 3965 K Standard halophosphate lamp.', SPD: std.SPDofFL3_2 },
	{ label: 'FL3.3', desc: 'CIE 6280 K Standard halophosphate lamp', SPD: std.SPDofFL3_3 },
	{ label: 'FL3.4', desc: 'CIE 2904 K Standard DeLuxe type lamp', SPD: std.SPDofFL3_4 },
	{ label: 'FL3.5', desc: 'CIE 4086 K Standard DeLuxe type lamp', SPD: std.SPDofFL3_5 },
	{ label: 'FL3.6', desc: 'CIE 4894 K Standard DeLuxe type lamp', SPD: std.SPDofFL3_6 },
	{ label: 'FL3.7', desc: 'CIE 2979 K 3 Band', SPD: std.SPDofFL3_7 },
	{ label: 'FL3.8', desc: 'CIE 4006 K 3 Band', SPD: std.SPDofFL3_8 },
	{ label: 'FL3.9', desc: 'CIE 4853 K 3 Band', SPD: std.SPDofFL3_9 },
	{ label: 'FL3.10', desc: 'CIE 5000 K 3 Band', SPD: std.SPDofFL3_10 },
	{ label: 'FL3.11', desc: 'CIE 5854 K 3 Band', SPD: std.SPDofFL3_11 },
	{ label: 'FL3.12', desc: 'CIE 2984 K Multi Band', SPD: std.SPDofFL3_12 },
	{ label: 'FL3.13', desc: 'CIE 3896 K Multi Band', SPD: std.SPDofFL3_13 },
	{ label: 'FL3.14', desc: 'CIE 5045 K Multi Band', SPD: std.SPDofFL3_14 },
	{ label: 'FL3.15', desc: 'CIE 6509 K Multi Band', SPD: std.SPDofFL3_15 },
	...
	{ label: 'HP1', desc: 'CIE 1959 K Standard high pressure sodium lamp', SPD: std.SPDofHP1 },
	{ label: 'HP2', desc: 'CIE 2506 K Colour enhanced high pressure sodium lamp', SPD: std.SPDofHP2 },
	{ label: 'HP3', desc: 'CIE 3144 K High pressure metal halide lamp', SPD: std.SPDofHP3 },
	{ label: 'HP4', desc: 'CIE 4002 K High pressure metal halide lamp', SPD: std.SPDofHP4 },
	{ label: 'HP5', desc: 'CIE 4039 K High pressure metal halide lamp', SPD: std.SPDofHP5 },
];
